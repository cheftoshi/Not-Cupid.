...
// seven additional people browseable (ten total); a fourth pick in the same cycle is an
...
export const LOVE_ROSTER_OPTIONS = 10;
export const LOVE_MAX_PENDING_INCOMING = 3;
