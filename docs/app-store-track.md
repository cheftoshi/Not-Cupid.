...
The native positioning and AI implementation sequence are defined in
`docs/ai-connection-product-thesis.md`. The App Store build should present one
AI connection concierge across Love, Friend, and real plans—not three unrelated
AI features or a generic dating wrapper.
...
App Review rule. Curated non-AI fallbacks must keep the core app usable when a
user declines.
