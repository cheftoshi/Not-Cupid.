      ...
      <div onClick={(e) => e.stopPropagation()} style={modal}>
        {done ? (
          <div style={{ textAlign: 'center', padding: '0.5rem 0' }}>
            ...
            <h2 style={{ fontFamily: 'Georgia, serif', fontSize: 22, color: 'var(--h-text)', margin: '0 0 10px' }}>Report submitted.</h2>
            <p style={{ fontFamily: 'system-ui, sans-serif', fontSize: 14, color: 'var(--h-text-dim)', lineHeight: 1.6, margin: '0 0 20px' }}>
          ...
          <>
            <div style={{ fontFamily: "'DM Mono', monospace", fontSize: 10, letterSpacing: '0.2em', textTransform: 'uppercase', color: 'var(--h-accent-2)', marginBottom: 8 }}>
              report &amp; block
            </div>
            <h2 style={{ fontFamily: 'Georgia, serif', fontSize: 22, color: 'var(--h-text)', margin: '0 0 6px' }}>Report {first}?</h2>
            <p style={{ fontFamily: 'system-ui, sans-serif', fontSize: 13, color: 'var(--h-text-dim)', lineHeight: 1.5, margin: '0 0 16px' }}>
              ...
              {REASONS.map((r) => (
                <button
                  ...
                  style={{
                    ...
                    border: `1.5px solid ${reason === r.value ? '#d2530f' : 'var(--h-border)'}`,
                    background: reason === r.value ? 'var(--h-surface-3)' : 'var(--h-surface)',
                    color: 'var(--h-text)',
                  }}
                >
                  {r.label}
            ...
            <textarea
              ...
              style={{ width: '100%', borderRadius: 10, border: '1px solid var(--h-border)', padding: '10px 12px', fontFamily: 'system-ui, sans-serif', fontSize: 13.5, resize: 'vertical', outline: 'none', marginBottom: 12 }}
            />
...
const modal: React.CSSProperties = { background: 'var(--h-surface)', borderRadius: 16, maxWidth: 440, width: '100%', padding: 24, maxHeight: '88vh', overflowY: 'auto', boxShadow: '0 20px 60px -20px rgba(11,11,11,0.4)' };
...
const ghost: React.CSSProperties = { background: 'transparent', color: 'var(--h-text-dim)', border: '1px solid var(--h-border)', borderRadius: 999, padding: '12px 18px', fontFamily: "'DM Mono', monospace", fontSize: 12, letterSpacing: '0.12em', textTransform: 'uppercase', cursor: 'pointer' };
