  ...
  try {
    ...
    if (!result.ok) {
      ...
      if (result.reason === 'at_capacity') {
        return htmlPage(
          'Your hands are full. ✋',
          `<p style="color:#7a7590;line-height:1.65;margin-bottom:2rem">Your three Love Line connection slots are full. Wrap one up on your dashboard, then come back and say yes — this match stays open until it expires.</p>
