  ...
  try {
    ...
    if (!result.ok) {
      ...
      if (result.reason === 'at_capacity') {
        return htmlPage(
          'Your hands are full. ✋',
          `<p style="color:#7a7590;line-height:1.65;margin-bottom:2rem">You reached the Love Line safety limit. End a connection on your dashboard only if you want to close it, then come back and say yes — this match stays open until it expires.</p>
