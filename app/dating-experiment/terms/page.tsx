...
export default function DatingExperimentTermsPage() {
  return (
    <LegalPage title="Dating Experiment Terms" subtitle="The complete rules for Dinner on Us: Boston." updated="August 8, 2026">
      ...
      <p>If more than one mutual pair exists, one dinner pair is selected at random. Compatibility receives a bounded 1×–3× weight; one person marking the other as a favorite multiplies that pair&apos;s weight by 1.2, and both marking each other as favorites multiplies it by 1.5. These weights affect relative odds but never guarantee selection. No human chooses the pair, and purchases or subscriptions never affect offers, choices, or weighting. Odds depend on the qualified pool and private decisions and cannot be known in advance.</p>
