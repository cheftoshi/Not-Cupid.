  ...
  return (
    <LegalPage title="Privacy Policy" subtitle="Plain-English version of what we collect and why." updated="August 2026">
      ...
      <ul>
        ...
        <li><strong>Anthropic</strong> — to generate optional AI suggestions and compatibility reads from limited, bounded context. Neither AI feature receives the contents of your chat messages; the compatibility read receives broad trait bands rather than raw answers or exact scores.</li>
      ...
      <h2>AI features</h2>
      <p>AI suggestions and compatibility reads are optional, may be imperfect, and are always yours to use or ignore. For the AI Compatibility Read, we send Anthropic a first name, the visible match score, aggregate compatibility reasons, shared interests, and broad lower/middle/higher relationship labels for the six personality dimensions. We do not send raw quiz answers or exact trait scores. For the chat Love coach, we send broad profile details you can already view, aggregate compatibility reasons, and conversation metadata such as message count and whether both people have participated. <strong>We do not send chat-message contents to either AI feature, and the coach never sends anything automatically.</strong> When an AI service is unavailable, NotCupid shows a curated non-AI fallback instead.</p>
