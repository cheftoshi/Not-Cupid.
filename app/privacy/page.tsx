  ...
  return (
    <LegalPage title="Privacy Policy" subtitle="Plain-English version of what we collect and why." updated="August 2026">
      ...
      <ul>
        ...
        <li><strong>Payments:</strong> when you pay (an optional Love compatibility deep-dive, an additional friendship pack, or Pro), <strong>Stripe</strong> processes it — we never see or store your full card number. We keep a record of the transaction and your subscription status.</li>
      ...
      <p>People who receive you in their Love roster can open your main photo, first name, age, bio, prompts, interests, archetype, occupation, relationship intent, metro label, and match reason before choosing. Your optional short introduction video is available inside a real connection. After you both connect, additional photos and deeper lifestyle, values, and connection-style details may be available through the optional compatibility deep-dive or Pro. We <strong>never</strong> show your exact address or ZIP — only a metro label (e.g.&nbsp;&quot;Boston, MA&quot;) and a fuzzy distance band.</p>
