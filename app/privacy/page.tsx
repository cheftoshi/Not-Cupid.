...
export default function PrivacyPage() {
  return (
    <LegalPage title="Privacy Policy" subtitle="Plain-English version of what we collect and why." updated="August 2026">
      ...
      <p>If you join the <a href="/dating-experiment">NotCupid Dating Experiment</a>, we collect your entry, availability confirmation, match basics, short answers, consent timestamps, terms version, required introduction video, reciprocal shortlist offers, and sealed yes/pass/favorite decisions. Your video is stored privately and is shown only to the people placed on reciprocal shortlists with you (up to two per round) and limited NotCupid administrators who operate or safeguard the experiment. Shortlist participants cannot see one another&apos;s decisions. Entering does <strong>not</strong> give us permission to use your name, photo, video, or story in advertising; any public or marketing use requires separate written consent. Experiment videos are scheduled for deletion after the round, subject to limited safety, fraud, dispute, and legal retention. Venue and time are shared only with the final mutually accepting dinner pair. See the <a href="/dating-experiment/terms">Dating Experiment Terms</a>.</p>
