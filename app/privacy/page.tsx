  ...
  return (
    <LegalPage title="Privacy Policy" subtitle="Plain-English version of what we collect and why." updated="August 2026">
      ...
      <ul>
        ...
        <li><strong>Payments:</strong> when you pay (an extra Love connection pick, an additional friendship pack, or Pro), <strong>Stripe</strong> processes it — we never see or store your full card number. We keep a record of the transaction and your subscription status.</li>
