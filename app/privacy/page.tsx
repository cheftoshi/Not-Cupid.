  ...
  return (
    <LegalPage title="Privacy Policy" subtitle="Plain-English version of what we collect and why." updated="August 2026">
      ...
      <ul>
        ...
        <li><strong>Anthropic</strong> — to generate optional AI suggestions, Hub concierge answers, and compatibility reads from limited, bounded context. We do not send the contents of your private Love/Friend conversations; the Hub concierge receives only the message you deliberately type to it plus the limited context disclosed before first use.</li>
