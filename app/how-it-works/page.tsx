...
const LOVE_STEPS = [
  ...
  { emoji: '👉', title: 'you pick', body: 'every 24-hour roster includes three distinct connection picks. all seven profiles stay free to browse; after the included three, each extra person you choose is a one-time $0.99 (or included with Pro). if that paid request is declined or expires before becoming mutual, it automatically returns as an in-app credit.' },
...
const RAFFLE_POINTS = [
  { e: '✅', t: 'how to join', b: `be 21+, live in Massachusetts within ${RAFFLE.radiusMiles} miles of ${RAFFLE.centerZip}, complete your profile, and answer four short experiment prompts. a private ${RAFFLE.videoMinSeconds}–${RAFFLE.videoMaxSeconds}s intro video is optional. joining is free.` },
  ...
  { e: '🔒', t: 'private by design', b: 'if you add an optional experiment video, only people placed on a reciprocal shortlist with you can view it. every yes, pass, and optional favorite stays sealed.' },
      ...
      <div style={{ maxWidth: 680, margin: '0 auto', padding: '1.5rem 1.25rem 4rem' }}>
        ...
        <div style={{ background: 'linear-gradient(135deg, rgba(255,106,31,0.13), var(--h-surface))', border: `2px solid ${ORANGE}`, borderRadius: 18, padding: '1.4rem 1.4rem 1.5rem', margin: '0 0 1.75rem', boxShadow: '0 18px 50px -30px rgba(255,106,31,0.55)' }}>
          ...
          <p style={{ fontSize: '0.66rem', lineHeight: 1.5, color: 'var(--h-text-faint)', margin: '0.85rem 0 0' }}>
            * No purchase necessary. Massachusetts residents 21+ within {RAFFLE.radiusMiles} miles of {RAFFLE.centerZip}. Up to two reciprocal options; only mutual yes pairs enter the final weighted selection for up to {RAFFLE.winnerPairCount} dinner prizes. Odds depend on the qualified pool and private choices. Void where prohibited. <Link href="/dating-experiment/terms" style={{ color: ORANGE_DEEP, textDecoration: 'underline' }}>Official Rules</Link>.
          </p>
        </div>
