...
const FAQS: { q: string; a: string }[] = [
  ...
  {
    q: 'Is it free?',
    a: 'The quiz and your matches are free. On the Love Line you can unlock someone’s full profile — bio, gallery and personality breakdown — for a one-time $1.99. No subscription, ever. On the Friend Line, your first crew chat is free.',
  },
  {
