...
export default function TermsPage() {
  return (
    <LegalPage title="Terms of Service" subtitle="The rules of the road. Be cool, and this all works." updated="August 2026">
      ...
      <h2>Payments</h2>
      <p>Core profiles, accepting, replying, blocking, reporting, and planning are free. Each Love roster includes three distinct connection picks. After those three, an additional person you choose costs a one-time $0.99 and includes chat if the interest becomes mutual; a match, acceptance, or reply is not guaranteed. Removing someone yourself does not replenish that roster&apos;s pick, while a decline or expiry returns an included pick. If a paid person becomes unavailable before the connection can be created, the payment remains available as an extra-connection credit for another current roster profile. Other optional paid features include additional Friend Line packs and NotCupid Pro. Prices and what is included are shown before you pay and processed by Stripe. Because these are digital goods delivered immediately, payments are generally <strong>non-refundable</strong> except where required by law. We may change pricing going forward.</p>
