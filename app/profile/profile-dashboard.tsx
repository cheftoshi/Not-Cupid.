    ...
    <div className={styles.dash}>
      ...
      <div className={styles.dashBasics}>
        ...
        <div className={styles.dashBasicsGrid}>
          ...
          <div className={styles.dashBasicItem}><span className={styles.dashBasicK}>availability</span><span className={styles.dashBasicV}>{user.love_availability === 'actively_looking' ? 'actively looking' : 'open to meeting'}</span></div>
